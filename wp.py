...
class Attribute:
    def _init_(self, name, bobot, maxmin, value):
        self._name      = name
        self._bobot     = bobot
        self._value     = value
        self._maxmin    = maxmin
...
def main():
    print("Program WP Beny Gugus Dita\n")
    laptops = []
...
def inputData(laptops):
    ...
    merk1.addAtribute(Attribute("Speed Processor", 8.0, 1, 5.0))
    merk1.addAtribute(Attribute("VGA", 2.0, 0, 5.0))
    merk1.addAtribute(Attribute("Layar", 7.5, 1, 7.0))
    merk1.addAtribute(Attribute("RAM", 8.0, 1, 7.5))
    merk1.addAtribute(Attribute("Jenis HD", 7.5, 1, 7.0))
    merk1.addAtribute(Attribute("Harga", 5.0, 0, 4.0))
    laptops.append(merk1)

    merk2 = Laptop("Asus 12B")
    merk2.addAtribute(Attribute("Speed Processor", 8.0, 1, 6.0))
    merk2.addAtribute(Attribute("VGA", 2.0, 0, 8.0))
    merk2.addAtribute(Attribute("Layar", 7.5, 1, 7.0))
    merk2.addAtribute(Attribute("RAM", 8.0, 1, 8.2))
    merk2.addAtribute(Attribute("Jenis HD", 7.5, 1, 7.0))
    merk2.addAtribute(Attribute("Harga", 5.0, 0, 4.7))
    laptops.append(merk2)

    merk3 = Laptop("Asus 12C")
    merk3.addAtribute(Attribute("Speed Processor", 8.0, 1, 7.0))
    merk3.addAtribute(Attribute("VGA", 2.0, 0, 8.3))
    merk3.addAtribute(Attribute("Layar", 7.5, 1, 8.7))
    merk3.addAtribute(Attribute("RAM", 8.0, 1, 7.5))
    merk3.addAtribute(Attribute("Jenis HD", 7.5, 1, 8.2))
    merk3.addAtribute(Attribute("Harga", 5.0, 0, 6.5))
    laptops.append(merk3)

    merk4 = Laptop("Asus 12D")
    merk4.addAtribute(Attribute("Speed Processor", 8.0, 1, 7.0))
    merk4.addAtribute(Attribute("VGA", 2.0, 0, 6.2))
    merk4.addAtribute(Attribute("Layar", 7.5, 1, 8.7))
    merk4.addAtribute(Attribute("RAM", 8.0, 1, 7.5))
    merk4.addAtribute(Attribute("Jenis HD", 7.5, 1, 7.0))
    merk4.addAtribute(Attribute("Harga", 5.0, 0, 6.5))
    laptops.append(merk4)

    merk5 = Laptop("Asus 12E")
    merk5.addAtribute(Attribute("Speed Processor", 8.0, 1, 6.5))
    merk5.addAtribute(Attribute("VGA", 2.0, 0, 7.3))
    merk5.addAtribute(Attribute("Layar", 7.5, 1, 7.5))
    merk5.addAtribute(Attribute("RAM", 8.0, 1, 8.7))
    merk5.addAtribute(Attribute("Jenis HD", 7.5, 1, 8.8))
    merk5.addAtribute(Attribute("Harga", 5.0, 0, 8.5))
